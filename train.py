...
def load_data(where  = "./flowers" ):
    ...
    validation_data = datasets.ImageFolder(valid_dir, transform=validation_data_transforms)
...
def train_model(model, optimizer, criterion, epochs, trainloader, power):
    ...
    for e in range(epochs):
        ...
        print("Validation Loss: {:.3f}".format(average_valid_loss))
        print("Accuracy: {:.3f}%".format(accuracy*100))

def save_checkpoint(path='checkpoint.pth', structure ='vgg16', hidden_layer1=120, dropout=0.2, lr=0.001, epochs=4):
